      ...
      >
        <p>
          <FormattedMessage
            ...
            Tweaks you make here can break large portions of Exact-Ti dashboard.
            ...
            Deleting a custom setting will permanently remove it from Exact-Ti Security Platform's config."
          />
        </p>
      </EuiCallOut>
    </div>
