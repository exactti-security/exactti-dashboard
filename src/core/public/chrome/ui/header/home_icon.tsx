...
export const HomeIcon = ({ branding, logos }: Props) => {
  // Removed prop unnecessary useExpandedHeader Exact-Ti dashboard
  const { applicationTitle = 'Exact-Ti dashboard', useExpandedHeader } = branding;
  ...
  // If no custom branded mark was set, use `home` icon Exact-Ti dashboard
